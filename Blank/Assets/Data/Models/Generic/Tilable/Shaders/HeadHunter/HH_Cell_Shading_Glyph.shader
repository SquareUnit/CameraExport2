...
Shader "HH_Cell_Shading_Glyph"
{
	Properties
	{
		...
		_headHunterGlyph("headHunterGlyph", 2D) = "white" {}
		_headHunterBase("headHunterBase", 2D) = "white" {}
		_glyphMult("glyphMult", Range( 0 , 1)) = 0
	...
	SubShader
	{
		...
		void outlineSurf( Input i, inout SurfaceOutput o )
		{
			...
			float3 normalizeResult4 = normalize( (WorldNormalVector( i , tex2D( _Normal_Map, uv_Normal_Map ).rgb )) );
		...
		uniform sampler2D _headHunterBase;
		uniform float4 _headHunterBase_ST;
		uniform sampler2D _headHunterGlyph;
		uniform float4 _headHunterGlyph_ST;
		uniform float _glyphMult;
		...
		inline half4 LightingStandardCustomLighting( inout SurfaceOutputCustomLightingCustom s, half3 viewDir, UnityGI gi )
		{
			...
			float3 lerpResult21 = lerp( temp_cast_5 , indirectSpecular20 , _Indirect_Spec);
			...
			#endif
			float2 uv_headHunterBase = i.uv_texcoord * _headHunterBase_ST.xy + _headHunterBase_ST.zw;
			float2 uv_headHunterGlyph = i.uv_texcoord * _headHunterGlyph_ST.xy + _headHunterGlyph_ST.zw;
			float4 lerpResult124 = lerp( tex2D( _headHunterBase, uv_headHunterBase ) , tex2D( _headHunterGlyph, uv_headHunterGlyph ) , _glyphMult);
			...
			float3 lerpResult54 = lerp( temp_cast_9 , indirectDiffuse52 , _Indirect_Diffuse);
...
/*ASEBEGIN
Version=16301
856;80;603;638;-1812.444;-1249.778;1;False;False
...
Node;AmplifyShaderEditor.SamplerNode;1;-3100.891,-332.5462;Float;True;Property;_Normal_Map;Normal_Map;0;0;Create;True;0;0;False;0;None;dcf4bfa742cc60b478b90dbfbd2b7a22;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;60;-2256.8,2566.835;Float;False;Property;_Base_Cell_Offset;Base_Cell_Offset;8;0;Create;True;0;0;False;0;0;-0.098;-1;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;38;-1656.791,452.7346;Float;False;Property;_Highlight_Tint;Highlight_Tint;4;0;Create;True;0;0;False;0;0.990566,0.990566,0.990566,0;0.990566,0.990566,0.990566,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;39;-1701.402,644.0446;Float;True;Property;_Highlight;Highlight;7;0;Create;True;0;0;False;0;None;9a645604f71e60b4eb571aecd80dcdad;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;53;-1166.21,1929.297;Float;False;Property;_Indirect_Diffuse;Indirect_Diffuse;9;0;Create;True;0;0;False;0;1;0.918;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;78;-359.4371,3079.84;Float;False;Property;_Base_Tint;Base_Tint;11;0;Create;True;0;0;False;0;1,1,1,0;1,1,1,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;89;-1171.792,3889.345;Float;False;Property;_Rim_Offset;Rim_Offset;12;0;Create;True;0;0;False;0;0.6;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;77;-475.9378,2884.943;Float;True;Property;_Base_ColorRGB_Outline_Width;Base_Color (RGB)_Outline_Width;10;0;Create;True;0;0;False;0;None;687f239a60b632449b610bdae4035bdd;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;33;-1266.311,1135.238;Float;False;Property;_HighlightCellOffset;Highlight Cell Offset;5;0;Create;True;0;0;False;0;-0.5;-0.5;-1;-0.5;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;34;-798.2283,1133.113;Float;False;Property;_Highlight_Cell_Sharpness;Highlight_Cell_Sharpness;6;0;Create;True;0;0;False;0;0.01;0.01;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;93;-533.6651,3898.199;Float;False;Property;_Rim_Power;Rim_Power;13;0;Create;True;0;0;False;0;0.4;0.238;0.01;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;23;-574.9774,-283.1643;Float;False;Property;_Indirect_Spec;Indirect_Spec;2;0;Create;True;0;0;False;0;1;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;104;1412.912,3507.483;Float;False;Property;_OutlineTint;Outline Tint;14;0;Create;True;0;0;False;0;0.5294118,0.5294118,0.5294118,0;0.5294118,0.5294118,0.5294118,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;118;1559.459,1625.414;Float;True;Property;_headHunterGlyph;headHunterGlyph;18;0;Create;True;0;0;False;0;None;019c954ac1120ac469a9efe6c052d747;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;123;1857.513,1740.623;Float;False;Property;_glyphMult;glyphMult;20;0;Create;True;0;0;False;0;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;117;1558.429,1441.898;Float;True;Property;_headHunterBase;headHunterBase;19;0;Create;True;0;0;False;0;None;687f239a60b632449b610bdae4035bdd;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;124;2185.343,1595.243;Float;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;106;1709.971,3733.999;Float;False;Property;_OutlineWidth;Outline Width;15;0;Create;True;0;0;False;0;0.2;0.0149;0;0.2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;116;2769.028,1485.847;Float;False;Property;_Emissivemultiplier;Emissive multiplier;17;0;Create;True;0;0;False;0;0;0;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;126;2454.779,1573.191;Float;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.RangedFloatNode;2;-3403.192,-321.8461;Float;False;Property;_Normal_Scale;Normal_Scale;3;0;Create;True;0;0;False;0;1;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;103;2679.586,1574.791;Float;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;127;3074.104,1296.738;Float;False;83;Base_Color;1;0;OBJECT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;50;3363.152,1343.784;Float;False;True;6;Float;ASEMaterialInspector;0;0;CustomLighting;HH_Cell_Shading_Glyph;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;15;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=73FB747F23BD8CDD4AFF7E6E3EBC4373F892F999