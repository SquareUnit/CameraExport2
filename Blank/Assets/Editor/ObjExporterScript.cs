...
public class ObjExporterScript : ScriptableObject
{
    ...
    [MenuItem("Tools/Modelisation/Export/Export all MeshFilters in selection to separate OBJs")]
    ...
    [MenuItem("Tools/Modelisation/Export/Export whole selection to single OBJ")]
    ...
    [MenuItem("Tools/Modelisation/Export/Export each selected to single OBJ")]
